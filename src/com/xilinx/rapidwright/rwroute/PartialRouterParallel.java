...
/**
 * A class extending {@link RWRouteParallel} for partial routing.
 ...
 */
public class PartialRouterParallel extends RWRouteParallel {
    ...
    public PartialRouterParallel(Design design, RWRouteConfig config, Collection<SitePinInst> pinsToRoute, boolean softPreserve) {
        super(design, config);
    ...
    public PartialRouterParallel(Design design, RWRouteConfig config, Collection<SitePinInst> pinsToRoute) {
    ...
    protected void preprocess() {
        ...
        // ahead of constructing this PartialRouterParallel class.
    ...
    public static Design routeDesignWithUserDefinedArguments(Design design,
        ...
        return routeDesign(design, new PartialRouterParallel(design, config, pinsToRoute, softPreserve));
    }
    ...
    /**
     * Calls {@link RWRouteParallel#preprocess(Design)} to preprocess the design, and furthermore
    ...
    public static void preprocess(Design design) {
        RWRouteParallel.preprocess(design);
    ...
    /**
     * The main interface of {@link PartialRouterParallel} that reads in a {@link Design} checkpoint,
    ...
    public static void main(String[] args) {
        ...
        CodePerfTracker t = new CodePerfTracker("PartialRouterParallel", true);
